...
export const getRestrictions = async (req: Request, res: Response) => {
    ...
    try {
        ...
        restrictions.allergies = await Allergy.find();
        restrictions.religious = await Religious.find();
        restrictions.intolerances = await Intolerance.find();
...
export const updateUsersRestrictions = async (req: Request, res: Response) => {
    ...
    try {
        ...
        if (!['allergies', 'religious', 'intolerances'].includes(key))
