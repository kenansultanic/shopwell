...
import {CircularProgress, ListItem, ListItemAvatar, ListItemIcon, ListItemText, Typography} from "@mui/material";
...
const ProductSearchList = () => {
    ...
    return (
        <List sx={{ width: '100%', maxWidth: 450, bgcolor: 'background.paper', my: 4 }}>
            {
                !products ?
                    <CircularProgress />
                    : products.length === 0 ? (
                            ...
                            products.map(({ code, name, imageURL, category }, i) => (
                                <ListItem
                                    alignItems="flex-start"
                                    key={i}
                                    onClick={() => navigate(`/product/${code}`)}
                                    style={{ cursor: 'pointer', margin: '2px 0', borderBottom: '1px solid lightgray' }}
                                >
                                    <ListItemAvatar>
